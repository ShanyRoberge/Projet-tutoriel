# Barème d'évaluation du tutoriel en manipulation de données
...
- CIP UdeS : robs1605
- ID GitHub : 
- Thème du tutoriel : Pandas 
- URL du tutoriel : https://github.com/ShanyRoberge/Projet-tutoriel
...
- [X] A2 - La synthèse des apprentissages est claire, mais n'est pas toujours précise ou pertinente pour la manipulation des données d'affaires.
...
- [ ] T2 - La structure du tutoriel est claire, logique et facile à suivre pour la manipulation des données d'affaires.
- [X] T3 - La structure du tutoriel est claire, mais n'est pas toujours logique ou facile à suivre pour la manipulation des données d'affaires.
...
Cette section évalue le respect des contraintes de format, de taille et de partage des fichiers du tutoriel. 
...
- Le tutoriel est pertinent pour la manipulation de données, mais il manque de structure.
- Les exemples sont génériques et peu utiles pour la manipulation de données d'affaires.
- L'utilisation du Markdown est erratique et peu soignée.